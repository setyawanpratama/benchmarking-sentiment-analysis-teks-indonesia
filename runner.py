...
def main(hf, templated, clean, raw):
    ...
    for i in clean:
        ...
        hf.create_dataset("fasttext_cb_100_" + i, data=result_ft_cb_100)
    end_time = time.time()
    get_time_diff(init_time, end_time, "FE-FastTextCBOW Vec100")
    ...
    for i in clean:
        ...
        hf.create_dataset("fasttext_cb_200_" + i, data=result_ft_cb_200)
    end_time = time.time()
    get_time_diff(init_time, end_time, "FE-FastTextCBOW Vec200")
    ...
    for i in clean:
        ...
        hf.create_dataset("fasttext_cb_300_" + i, data=result_ft_cb_300)
    end_time = time.time()
    get_time_diff(init_time, end_time, "FE-FastTextCBOW Vec300")
    ...
    for i in clean:
        ...
        hf.create_dataset("fasttext_sg_100_" + i, data=result_ft_sg_100)
    end_time = time.time()
    get_time_diff(init_time, end_time, "FE-FastTextSG Vec100")
    ...
    for i in clean:
        ...
        hf.create_dataset("fasttext_sg_200_" + i, data=result_ft_sg_200)
    end_time = time.time()
    get_time_diff(init_time, end_time, "FE-FastTextSG Vec200")
    ...
    for i in clean:
        ...
        hf.create_dataset("fasttext_sg_300_" + i, data=result_ft_sg_300)
    end_time = time.time()
    get_time_diff(init_time, end_time, "FE-FastTextSG Vec300")
